...
INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 14, 'Traditional Delight', 'Union Pils, brewed traditionally with a double-decoction mash, offers a delightful balance of malt flavor and floral, spicy aroma from Czech Saaz hops. A classic choice for pilsner lovers.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 14, 'Floral and Spicy Notes', 'The floral and spicy notes of Union Pils make it stand out. The double-decoction mash enhances the malt flavor, creating a well-rounded and enjoyable Bohemian Lager.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 14, 'Smooth Lager Experience', 'Union Pils delivers a smooth lager experience with vibrant malt flavors and a floral, spicy aroma. Lagered horizontally for two months, it showcases clarity of flavor.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 15, 'Double Dry-Hopped Bliss', 'Evil Motives is a double dry-hopped IPA that lives up to its name. Big hop additions of Citra, Simcoe, and Mosaic create a blissful combination of smooth bitterness and intense aroma.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 15, 'Aromatic Experience', 'For hop enthusiasts, Evil Motives offers an aromatic delight. The clean finish complements the big hop additions, making it a well-balanced and enjoyable IPA.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 15, 'Bold and Aromatic', 'Evil Motives is bold, aromatic, and delivers on the promise of a double dry-hopped IPA. The combination of Citra, Simcoe, and Mosaic hops creates a memorable drinking experience.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 16, 'Silky Stout Perfection', 'SAF Stroopwaffel is a silky stout perfection with copious amounts of flaked oats. The infusion of caramel and cinnamon, along with pure nitrogen, creates a creamy and delightful experience.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 16, 'Smooth and Creamy', 'The nitro-infused SAF Stroopwaffel delivers a smooth and creamy stout experience. The rich character, infused with caramel and cinnamon, makes it a must-try for stout lovers.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 16, 'Maximum Creaminess Achieved', 'SAF Stroopwaffel achieves maximum creaminess with its nitro infusion. The rich character, combined with caramel and cinnamon, makes it a standout nitro oatmeal stout.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 17, 'Classic and Balanced', 'Cleveland Brew’d Brown Ale is a classic brown ale with a balanced blend of sweet and roasted malt flavors. The nutty, coffee-like finish adds to its appeal.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 17, 'Hint of Peppery Rye', 'An enjoyable brown ale with a hint of peppery rye. Cleveland Brew’d Brown Ale offers a classic experience with a balanced mix of sweet and roasted malt flavors.', 3);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 17, 'Balanced and Nutty', 'Cleveland Brew’d Brown Ale is a balanced brew with nutty and coffee-like flavors. The hint of peppery rye adds a unique twist, making it a solid choice for brown ale enthusiasts.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 18, 'Uncanny Cinnamon Rolls', 'Cinnamon Roll Imperial Ale lives up to its name. The blend of toasted malts, spicy hops, and creamy lactose sugar creates an uncanny resemblance to fresh-baked cinnamon rolls.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 18, 'Spicy and Creamy', 'Incredible! Cinnamon Roll Imperial Ale blends spicy hops with creamy lactose sugar, achieving a perfect balance. It’s a delightful brew that captures the essence of cinnamon rolls.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 18, 'Spiced Perfection', 'Cinnamon Roll Imperial Ale is spiced perfection in a bottle. The combination of toasted malts, spicy hops, and creamy lactose sugar creates a unique and enjoyable imperial ale.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 19, 'Tropical Burst', 'Juice Jolt lives up to its name with a burst of tropical fruit flavor. At 6.8% ABV, it delivers a punch of delicious fruit juice with an intense aroma. A caution well heeded!', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 19, 'Easy-Drinking IPA', 'For an Extra Juicy IPA, Juice Jolt is surprisingly easy to drink. The tropical fruit flavor is refreshing, and the 6.8% ABV doesn’t overpower the overall experience.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 19, 'Too Juicy to Resist', 'Juice Jolt is indeed too juicy to resist! The tropical fruit flavor and intense aroma make it a standout IPA. Caution is right; it’s a juicy delight!', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 20, 'Bold and Inspiring', 'Airing of Grievances is a bold and inspiring beer. The rye malts provide a spicy backbone, and the Simcoe and Centennial hops add an aggressive, resinous, and piney hop flavor.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 20, 'Resinous Hop Delight', 'For hop enthusiasts, Airing of Grievances is a delight. The resinous and piney hop flavor, coupled with the spicy backbone from rye malts, creates a memorable Red Rye IPA.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 20, 'Dominate with Delight', 'A beer to dominate with! Airing of Grievances has a delicate malt body, snappy hop finish, and an overall refreshing quality. It keeps you dominating all day with its delightful flavor.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 21, 'Crisp and Refreshing', 'The OG lives up to its name. Crisp, light, and refreshing, with a delicate malt body and a snappy hop finish. A go-to beer for those who enjoy a clean and easy-drinking lager.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 21, 'All-Day Dominance', 'The OG is an all-day dominator! With its crisp, light, and brilliant profile, it’s a refreshing choice that keeps you dominating. A must-try for lager enthusiasts.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 21, 'Sessionable Delight', 'The OG is a sessionable delight. Crisp, refreshing, and easy to dominate all day. The delicate malt body and snappy hop finish make it a go-to choice for a light lager.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 22, 'Banana Clove Balance', 'B.F.heFe achieves a well-balanced profile with a soft wheat body and prominent banana clove character. A delightful hefeweizen for those who appreciate the classic style.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 22, 'Classic Hefeweizen Experience', 'For a classic hefeweizen experience, B.F.heFe hits the mark. The balance between the soft wheat body and banana clove character makes it a refreshing and enjoyable brew.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 22, 'Hefeweizen Harmony', 'B.F.heFe achieves harmony with its well-balanced blend of a soft wheat body and banana clove character. A delightful choice for hefeweizen enthusiasts.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 23, 'Rich Coffee Delight', 'Fauxbia is dripping with rich coffee and sweet vanilla flavor. The full-bodied experience and chocolatey finish make it a delightful choice.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 23, 'White Stout Heaven', 'As a white stout enthusiast, Fauxbia exceeded my expectations. The blend of coffee and vanilla creates a heavenly experience with a chocolatey finish.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 24, 'Pumpkin Spice Bliss', 'Boo Thang is a pumpkin spice bliss! The hints of caramel, cinnamon, nutmeg, and ginger create a perfect harmony in this Imperial Pumpkin Ale.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 24, 'Fall in a Glass', 'Brewed with pumpkin purée and spices, Boo Thang captures the essence of fall. The rich flavors and warming spices make it a seasonal favorite.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 25, 'Original Gangster', 'Space Chimp Wit OG, the original gangster, is a refreshing witbier brewed with bitter orange and coriander. It’s a classic that never disappoints.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 25, 'Citrusy Delight', 'The citrusy notes from bitter orange in Space Chimp Wit OG are delightful. A great choice for those who appreciate a crisp and flavorful witbier.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 26, 'Crazy Tropical Top Notes', 'Fresh Hop BBFCFM is a black IPA with crazy tropical top notes. The combination of Simcoe hops and @phantasm.nz powder creates an extremely bright and flavorful experience.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 26, 'Crush-Worthy', 'This cuddly but muscular Black IPA is indeed crush-worthy! The vibrant flavors make it a go-to choice after a day of work.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 27, 'Cozy Lager', 'Catching Smoke is a cozy lager brewed with beechwood smoked malt, providing a complex and sophisticated taste. A true brewer’s beer!', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 27, 'Smokey Excellence', 'The beechwood smoked malt in Catching Smoke adds a layer of complexity, creating a brewer’s beer with a sophisticated and excellent taste.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 28, 'Summer Memories', 'Blazin’ Blue Raspberry brings back past memories of summer days with its tart and refreshing wheat beer brewed with Blue Raspberry Lemonade Kool-Aid packets.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 28, 'Tart Refreshment', 'Brewed with Blue Raspberry Lemonade Kool-Aid packets, Blazin’ Blue Raspberry offers tart refreshment and a hint of nostalgia.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 29, 'Classic German Vibes', 'Oktoberfest is a true classic German style beer. The toasty autumnal flavors and vibrant malt make it a perfect choice for hearty hoisting.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 29, 'Festive Celebration', 'With its festive flourish of noble hops, Oktoberfest is lederhosen-worthy indeed. It’s a malt party in a glass that deserves a celebration.', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 30, 'Extreme Conditions', 'Arctic Ancient is an epic Imperial IPA packed with chill-busting juicy hop notes. Perfect for sipping by the fire in extreme conditions!', 4);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 30, 'Hoppy Bliss', 'The chill-busting juicy hop notes in Arctic Ancient create a hoppy bliss that makes it perfect for a cozy evening by the fire.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 31, 'Award-Winning Classic', 'Dortmunder Gold is a classic award-winning balance of sweet malt and dry hop flavors. Proudly waving the flag for Cleveland and refreshing beer drinkers everywhere since 1988.', 5);

INSERT INTO review (user_id, beer_id, title, body, rating) VALUES (1, 31, 'Smooth and Refreshing', 'The smooth and refreshing taste of Dortmunder Gold is a testament to its award-winning balance of sweet malt and dry hop flavors. A timeless classic.', 4);
